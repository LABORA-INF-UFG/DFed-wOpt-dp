    ...
    def round_costs(self):
        ...
        for i, ue in enumerate(self.selected_clients):
            ...
            if ue in self.success_uploads:
                round_energy_success = round_energy_success + self.tm.total_energy[ue, self.rb_allocation[i], self.user_power_allocation[i]]
                round_delay_upload_success = round_delay_upload_success + self.tm.user_delay[ue, self.rb_allocation[i], self.user_power_allocation[i]]
            else:
                round_energy_error = round_energy_error + self.tm.total_energy[ue, self.rb_allocation[i], self.user_power_allocation[i]]
